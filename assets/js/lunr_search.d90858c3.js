         ...
         */ !(function () {
            ...
            (R.version = "2.3.0"),
                ...
                (R.Set.prototype.union = function (e) {
                    return new R.Set(Object.keys(this.elements).concat(Object.keys(e.elements)));
                }),
                (R.idf = function (e, t) {
                    var r = 0;
                 ...
                 */ (R.tokenizer = function (e, t) {
                    ...
                    for (var r = e.toString().trim().toLowerCase(), n = r.length, i = [], s = 0, o = 0; s <= n; s++) {
                        var a = s - o;
                        if (r.charAt(s).match(R.tokenizer.separator) || s == n) {
                            if (a > 0) {
                                var u = R.utils.clone(t) || {};
                                (u.position = [o, a]), (u.index = i.length), i.push(new R.Token(r.slice(o, s), u));
                            }
                            o = s + 1;
                        }
                    }
                ...
                (R.Pipeline.load = function (e) {
                    ...
                    return (
                        e.forEach(function (e) {
                            var r = R.Pipeline.registeredFunctions[e];
                ...
                (R.Pipeline.prototype.run = function (e) {
                    for (var t = this._stack.length, r = 0; r < t; r++) {
                        for (var n = this._stack[r], i = [], s = 0; s < e.length; s++) {
                            var o = n(e[s], s, e);
                            if (void 0 !== o && "" !== o)
                                if (o instanceof Array) for (var a = 0; a < o.length; a++) i.push(o[a]);
                                else i.push(o);
                        }
                        e = i;
                    }
                ...
                (R.Vector.prototype.positionForIndex = function (e) {
                    ...
                    for (var t = 0, r = this.elements.length / 2, n = r - t, i = Math.floor(n / 2), s = this.elements[2 * i]; n > 1 && (s < e && (t = i), s > e && (r = i), s != e); )
                        (n = r - t), (i = t + Math.floor(n / 2)), (s = this.elements[2 * i]);
                    return s == e ? 2 * i : s > e ? 2 * i : s < e ? 2 * (i + 1) : void 0;
                }),
                ...
                (R.Vector.prototype.upsert = function (e, t, r) {
                    this._magnitude = 0;
                ...
                (R.Vector.prototype.dot = function (e) {
                    for (var t = 0, r = this.elements, n = e.elements, i = r.length, s = n.length, o = 0, a = 0, u = 0, l = 0; u < i && l < s; )
                 ...
                 */ (R.stemmer =
                    ...
                    (I = function (e) {
                        ...
                        if (("y" == (n = e.substr(0, 1)) && (e = n.toUpperCase() + e.substr(1)), (s = y), (i = p).test(e) ? (e = e.replace(i, "$1$2")) : s.test(e) && (e = e.replace(s, "$1$2")), (s = g), (i = m).test(e))) {
                            var I = i.exec(e);
                            (i = c).test(I[1]) && ((i = x), (e = e.replace(i, "")));
                        } else if (s.test(e)) {
                            (t = (I = s.exec(e))[1]), (s = f).test(t) && ((u = w), (l = Q), (s = v).test((e = t)) ? (e += "e") : u.test(e) ? ((i = x), (e = e.replace(i, ""))) : l.test(e) && (e += "e"));
                        }
                        if (
                            ((i = k).test(e) && (e = (t = (I = i.exec(e))[1]) + "i"),
                            (i = S).test(e) && ((t = (I = i.exec(e))[1]), (r = I[2]), (i = c).test(t) && (e = t + o[r])),
                            (i = b).test(e) && ((t = (I = i.exec(e))[1]), (r = I[2]), (i = c).test(t) && (e = t + a[r])),
                            (s = L),
                            (i = E).test(e))
                        )
                            (t = (I = i.exec(e))[1]), (i = d).test(t) && (e = t);
                        else if (s.test(e)) {
                            (t = (I = s.exec(e))[1] + I[2]), (s = d).test(t) && (e = t);
                        }
                        return (
                            (i = T).test(e) && ((t = (I = i.exec(e))[1]), (s = h), (u = O), ((i = d).test(t) || (s.test(t) && !u.test(t))) && (e = t)),
                            (s = d),
                            (i = P).test(e) && s.test(e) && ((i = x), (e = e.replace(i, ""))),
                ...
                (R.TokenSet.fromArray = function (e) {
                    for (var t = new R.TokenSet.Builder(), r = 0, n = e.length; r < n; r++) t.insert(e[r]);
                ...
                (R.TokenSet.fromFuzzyString = function (e, t) {
                    for (var r = new R.TokenSet(), n = [{ node: r, editsRemaining: t, str: e }]; n.length; ) {
                        var i,
                            s,
                            o,
                            a = n.pop();
                        if (a.str.length > 0)
                            (s = a.str.charAt(0)) in a.node.edges ? (i = a.node.edges[s]) : ((i = new R.TokenSet()), (a.node.edges[s] = i)),
                                1 == a.str.length ? (i.final = !0) : n.push({ node: i, editsRemaining: a.editsRemaining, str: a.str.slice(1) });
                        if (a.editsRemaining > 0 && a.str.length > 1)
                            (s = a.str.charAt(1)) in a.node.edges ? (o = a.node.edges[s]) : ((o = new R.TokenSet()), (a.node.edges[s] = o)),
                                a.str.length <= 2 ? (o.final = !0) : n.push({ node: o, editsRemaining: a.editsRemaining - 1, str: a.str.slice(2) });
                        if ((a.editsRemaining > 0 && 1 == a.str.length && (a.node.final = !0), a.editsRemaining > 0 && a.str.length >= 1)) {
                            if ("*" in a.node.edges) var u = a.node.edges["*"];
                            else {
                                u = new R.TokenSet();
                                a.node.edges["*"] = u;
                            }
                            1 == a.str.length ? (u.final = !0) : n.push({ node: u, editsRemaining: a.editsRemaining - 1, str: a.str.slice(1) });
                        }
                        if (a.editsRemaining > 0) {
                            ...
                            0 == a.str.length ? (l.final = !0) : n.push({ node: l, editsRemaining: a.editsRemaining - 1, str: a.str });
                        }
                        if (a.editsRemaining > 0 && a.str.length > 1) {
                            var c,
                                d = a.str.charAt(0),
                                h = a.str.charAt(1);
                            h in a.node.edges ? (c = a.node.edges[h]) : ((c = new R.TokenSet()), (a.node.edges[h] = c)),
                                1 == a.str.length ? (c.final = !0) : n.push({ node: c, editsRemaining: a.editsRemaining - 1, str: d + a.str.slice(2) });
                        }
                    }
                    return r;
                }),
                (R.TokenSet.fromString = function (e) {
                    for (var t = new R.TokenSet(), r = t, n = !1, i = 0, s = e.length; i < s; i++) {
                        var o = e[i],
                            a = i == s - 1;
                        if ("*" == o) (n = !0), (t.edges[o] = t), (t.final = a);
                        else {
                            var u = new R.TokenSet();
                            (u.final = a), (t.edges[o] = u), (t = u), n && (t.edges["*"] = r);
                        }
                    }
                    return r;
                }),
                ...
                (R.TokenSet.prototype.intersect = function (e) {
                    for (var t = new R.TokenSet(), r = void 0, n = [{ qNode: e, output: t, node: this }]; n.length; ) {
                        r = n.pop();
                            ...
                            for (var l = i[u], c = 0; c < a; c++) {
                                ...
                                if (d == l || "*" == l) {
                                    var h = r.node.edges[d],
                                        ...
                                        p = h.final && f.final,
                                        y = void 0;
                                    d in r.output.edges ? ((y = r.output.edges[d]).final = y.final || p) : (((y = new R.TokenSet()).final = p), (r.output.edges[d] = y)), n.push({ qNode: f, output: y, node: h });
                                }
                            }
                    }
                    return t;
                ...
                (R.Index.prototype.query = function (e) {
                    for (var t = new R.Query(this.fields), r = Object.create(null), n = Object.create(null), i = Object.create(null), s = Object.create(null), o = Object.create(null), a = 0; a < this.fields.length; a++)
                        n[this.fields[a]] = new R.Vector();
                    e.call(t, t);
                            ...
                            for (var m = 0; m < p.length; m++) {
                                ...
                                for (y = 0; y < u.fields.length; y++) {
                                    var w = x[(F = u.fields[y])],
                                        ...
                                        k = g + "/" + F,
                                        S = new R.Set(Q);
                                    if ((u.presence == R.Query.presence.REQUIRED && ((c = c.union(S)), void 0 === s[F] && (s[F] = R.Set.complete)), u.presence != R.Query.presence.PROHIBITED)) {
                                        if (
                                            (n[F].upsert(v, u.boost, function (e, t) {
                                                return e + t;
                                            }),
                                            !i[k])
                                        ) {
                                            for (var b = 0; b < Q.length; b++) {
                                                var E,
                                                    L = Q[b],
                                                    T = new R.FieldRef(L, F),
                                                    P = w[L];
                                                void 0 === (E = r[T]) ? (r[T] = new R.MatchData(g, F, P)) : E.add(g, F, P);
                                            }
                                            i[k] = !0;
                                        }
                                    } else void 0 === o[F] && (o[F] = R.Set.empty), (o[F] = o[F].union(S));
                                }
                            }
                        }
                    ...
                    for (a = 0; a < this.fields.length; a++) {
                        var F;
                        s[(F = this.fields[a])] && (O = O.intersect(s[F])), o[F] && (I = I.union(o[F]));
                    }
                    var j = Object.keys(r),
                        _ = [],
                        N = Object.create(null);
                    if (t.isNegated()) {
                        j = Object.keys(this.fieldVectors);
                        for (a = 0; a < j.length; a++) {
                            T = j[a];
                            var C = R.FieldRef.fromString(T);
                            r[T] = new R.MatchData();
                        }
                    }
                    for (a = 0; a < j.length; a++) {
                        var D = (C = R.FieldRef.fromString(j[a])).docRef;
                        if (O.contains(D) && !I.contains(D)) {
                            var A,
                                B = this.fieldVectors[C],
                                M = n[C.fieldName].similarity(B);
                            if (void 0 !== (A = N[D])) (A.score += M), A.matchData.combine(r[C]);
                            else {
                                var V = { ref: D, score: M, matchData: r[C] };
                                (N[D] = V), _.push(V);
                            }
                        }
                    }
                ...
                (R.Index.load = function (e) {
                    ...
                    return o.finish(), (t.fields = e.fields), (t.fieldVectors = r), (t.invertedIndex = i), (t.tokenSet = o.root), (t.pipeline = a), new R.Index(t);
                }),
                /*!
                 * lunr.Builder
                 * Copyright (C) 2018 Oliver Nightingale
                ...
                (R.Builder.prototype.calculateAverageFieldLengths = function () {
                    for (var e = Object.keys(this.fieldLengths), t = e.length, r = {}, n = {}, i = 0; i < t; i++) {
                        var s = R.FieldRef.fromString(e[i]),
                            o = s.fieldName;
                ...
                (R.Builder.prototype.createFieldVectors = function () {
                    for (var e = {}, t = Object.keys(this.fieldTermFrequencies), r = t.length, n = Object.create(null), i = 0; i < r; i++) {
                        for (
                            var s = R.FieldRef.fromString(t[i]),
                                o = s.fieldName,
                            ...
                            void 0 === n[x] ? ((y = R.idf(this.invertedIndex[x], this.documentCount)), (n[x] = y)) : (y = n[x]),
                                (m = (y * ((this._k1 + 1) * v)) / (this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[o])) + v)),
                                (m *= h),
                                (m *= f),
                ...
                (R.MatchData.prototype.add = function (e, t, r) {
                ...
                (R.QueryParseError = function (e, t, r) {
                ...
                (R.QueryLexer.lexTerm = function (e) {
                    if ((e.width() > 1 && (e.backup(), e.emit(R.QueryLexer.TERM)), e.ignore(), e.more())) return R.QueryLexer.lexText;
                }),
                    ...
                    if (null != t)
                        switch (t.type) {
                            ...
                            default:
                                ...
                                throw (t.str.length >= 1 && (r += " with value '" + t.str + "'"), new R.QueryParseError(r, t.start, t.end));
                        }
                }),
    ...
    39: function (e, t, r) {
        ...
        var n = r(15),
            ...
            o = function (e, t, r, n) {
                Object(s.d)(n);
                var i = e
                    ? t.search(e).map(function (e) {
                          return { href: e.ref, title: r[e.ref] };
                      })
                    : [];
                Object(s.a)(i, n);
            },
            a = i.a.Index.load(window.lunr_idx),
            u = window.page_titles,
            l = document.getElementById("search-term"),
